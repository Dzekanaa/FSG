...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/onboarding1Page',
          builder: (context, params) => Onboarding1PageWidget(
            fortext: params.getParam('fortext', ParamType.bool),
          ),
        ),
        FFRoute(
          name: 'LoginPage',
        ...
        FFRoute(
          name: 'Robin3PhoneAuthPage',
          path: '/robin3PhoneAuthPage',
          builder: (context, params) => Robin3PhoneAuthPageWidget(),
        ),
        FFRoute(
          name: 'VerifyCode',
          path: '/verifyCode',
        ...
        FFRoute(
          ...
          builder: (context, params) => HistoryPageWidget(
            nema: params.getParam('nema', ParamType.bool),
          ),
        ),
        FFRoute(
          name: 'profile',
        ...
        FFRoute(
          name: 'FoodChoises',
          path: '/foodChoises',
          builder: (context, params) => FoodChoisesWidget(),
        ),
        FFRoute(
          name: 'AboutUs',
          path: '/aboutUs',
